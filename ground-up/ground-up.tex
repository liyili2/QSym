...
This is analogous to how entanglement works in the case of a quantum circuit. In quantum terminology, we would say that the result is that the state is \textit{entangled} or \textit{not separable}. This is in contrast to \textit{separable states}.

% or \textit{entangled} Recall that the tensor product
